class script(object):
    START_TXT = """𝖧𝖤𝖫𝖫𝖮  {},
𝖬𝖸 𝖭𝖠𝖬𝖤 𝖨𝖲 <a href=https://t.me/{}>{}</a>, ഞാൻ <a href=https://t.me/Movietym_official_group>MOVIE TIME</a> ഗ്രൂപ്പിലെ ബോട്ടാണ് നിങ്ങൾക്ക് പുതിയ സിനിമകൾ വേണോ..? എങ്കിൽ പെട്ടെന്ന് തന്നെ ഞങ്ങളുടെ ഗ്രൂപ്പിൽ ജൊയിൻ ചെയ്യു ...🤩"""
    HELP_TXT = """𝙷𝙴𝚈 {}
𝙷𝙴𝚁𝙴 𝙸𝚂 𝚃𝙷𝙴 𝙷𝙴𝙻𝙿 𝙵𝙾𝚁 𝙼𝚈 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇:<a href=https://t.me/Movietymofficial>𝙈𝙊𝙑𝙄𝙀 𝙏𝙄𝙈𝙀</a>
✯ 𝙂𝙍𝙊𝙐𝙋:<a href=https://t.me/Movietym_official_group>𝙈𝙊𝙑𝙄𝙀 𝙏𝙄𝙈𝙀 𝙂𝙍𝙊𝙐𝙋</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
